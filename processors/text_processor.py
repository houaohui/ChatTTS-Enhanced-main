...
from utils.text_utils import replace_tokens,split_text,restore_tokens,replace_roman_numerals
...
def process_text(lines, min_length):
    lines_ = replace_roman_numerals(lines)
    replaced_tokens = replace_tokens(lines_)
